...
extension AudioDevice {
    ...
    /// :nodoc:
    @available(*, deprecated, message: "Marked for removal in 3.2. Use lookup(by:)") public static func lookupByID(_ id: AudioObjectID) -> AudioDevice? {

        return lookup(by: id)
    }

    /// :nodoc:
    @available(*, deprecated, message: "Marked for removal in 3.2. Use lookup(by:)") public static func lookupByUID(_ uid: String) -> AudioDevice? {

        return lookup(by: uid)
    }

...
[![Build Status](http://img.shields.io/travis/smileyborg/PureLayout.svg?style=flat)](https://travis-ci.org/rnine/AMCoreAudio)
...
**Note:** If you are targetting OS X 10.7 or 10.8 please use the [AMCoreAudio objc branch](https://github.com/rnine/AMCoreAudio/tree/objc).
